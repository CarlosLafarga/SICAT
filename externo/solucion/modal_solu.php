           ...
           <div class="modal inmodal" id="modal_solu" tabindex="-1" role="dialog" aria-hidden="true">
           ...
           <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="col-md-4">
            <h3>Fallas proyector</h3>
            <input type="radio" name="aulam" value="male"> No Enciende<br>
            <input type="radio" name="aulam" value="female"> No proyecta imagen<br>
            <input type="radio" name="aulam" value="other"> Imagen Borrosa<br>
            <input type="radio" name="aulam" value="other"> Se reinicia<br>
            ...
            <div class="col-md-4">
            <h3>Fallas Servidor</h3>
            <input type="radio" name="aula_hdt" value="male"> No enciende<br>
            <input type="radio" name="aula_hdt" value="female"> Sistema operativo<br>
            <input type="radio" name="aula_hdt" value="other"> Otra falla
            <input type="text" disabled name="otrafalla_hdt" class="form-control">
            </div>

            <div class="col-md-4">
            <h3>Fallas Regulador</h3>
            <input type="radio" name="aula_hdt" value="male"> No enciende<br>
            <input type="radio" name="aula_hdt" value="other"> Otra falla
            <input type="text" disabled name="otrafalla_hdt" class="form-control">
            </div>
